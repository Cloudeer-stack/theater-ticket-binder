    ...
    <div className="h-full w-full relative bg-neutral-900 overflow-hidden">
      <div className="h-full w-full relative overflow-y-auto pb-20">
        ...
        {ticket.posterImage ? (
          <>
            <div 
              className="absolute inset-0 bg-cover bg-center pointer-events-none opacity-50 z-0 h-full"
              style={{ backgroundImage: `url(${ticket.posterImage})` }}
            />
            <div className="absolute inset-0 bg-black/30 backdrop-blur-xl pointer-events-none z-0 h-full" />
          </>
        ) : (
           <div className="absolute inset-0 bg-gradient-to-br from-neutral-800 to-neutral-900 pointer-events-none z-0 h-full" />
        )}
      ...
      <div className="absolute bottom-6 right-6 flex flex-col space-y-3 z-50">
        <button
          onClick={onEdit}
